import 'node:fs';
import 'node:path';
import { b as br, O as On } from '../shared/nuxi.11eb953d.mjs';
import 'node:http';
import 'node:https';
import 'node:zlib';
import 'node:stream';
