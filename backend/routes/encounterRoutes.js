...
import { createEncounter, deleteEncounter, getEncounters, getEncounterDetails, updateEncounter } from "../controllers/encounterController.js"
...
router.route("/encounters/:id").get(isAuth, getEncounterDetails);
